...
class User extends \Core\Model
{
    ...
    public static function findByID($id)
    {
        ...
        $db = static::getDB();
        $stmt = $db->prepare($sql);
        $stmt->bindValue(':id', $id, PDO::PARAM_INT);  /*  bind value like integer, beacause id is integer */
    ...
    public function rememberLogin()
    {
        ...
        $stmt->bindValue(':expires_at', date('Y-m-d H:i:s', $this->expiry_timestamp), PDO::PARAM_STR); /* the way to work date time */
   ...
   /**
    ...
    {
        $token = new Token($token);  //new token object
        $hashed_token = $token->getHash();  //get a hash
        ...
        if (empty($this->errors)) {
            ...
            $sql = 'UPDATE users
                    SET password_hash = :password_hash,
                        password_reset_hash = NULL,/*  reset field */
                        password_reset_expires_at = NULL  /*  reset field */
                    WHERE id = :id';
